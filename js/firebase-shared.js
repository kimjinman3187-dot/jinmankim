    ...
    function injectFinanceApprovalSection() {
        ...
        anchor.insertAdjacentHTML('beforebegin', `
            <div id='pcFinanceApprovalWaitSection' class='bg-[#1e293b] border border-[#334155] rounded-2xl shadow-xl overflow-hidden mb-8'>
                ...
                <div class='overflow-x-auto'><table class='w-full text-left text-[11px] text-slate-300'><thead class='bg-[#0f1522] text-slate-500 font-bold border-b border-[#334155]'><tr><th class='px-4 py-3'>납기일</th><th class='px-4 py-3'>거래처명</th><th class='px-4 py-3'>자재 / 수량</th><th class='px-4 py-3 text-right'>예상 금액</th><th class='px-4 py-3 text-center'>상태</th><th class='px-4 py-3 text-center'>처리</th></tr></thead><tbody id='pcFinanceApprovalWaitBody' class='divide-y divide-[#334155]/50'><tr><td colspan='6' class='px-4 py-8 text-center text-slate-500 font-bold'>신규 승인 대기 데이터가 없습니다.</td></tr></tbody></table></div>
            </div>`);
    }
